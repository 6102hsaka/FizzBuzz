...
class FizzBuzzTest {
	...
	void testForPresenceOf3() {
		assertAll("Test for presence of 3 in number",
				() -> assertEquals("Fizz", FizzBuzzImpl.getResult(13), "This Should return Fizz"),
				() -> assertEquals("Fizz", FizzBuzzImpl.getResult(43), "This Should return Fizz"),
				() -> assertEquals("Fizz", FizzBuzzImpl.getResult(73), "This Should return Fizz"),
				() -> assertEquals("Fizz", FizzBuzzImpl.getResult(83), "This Should return Fizz"));
	}

	@Test
	void testForPresenceOf5() {
		assertAll("Test for presence of 3 in number",
				() -> assertEquals("Buzz", FizzBuzzImpl.getResult(50), "This Should return Buzz"),
				() -> assertEquals("Buzz", FizzBuzzImpl.getResult(52), "This Should return Buzz"),
				() -> assertEquals("Buzz", FizzBuzzImpl.getResult(56), "This Should return Buzz"),
				() -> assertEquals("Buzz", FizzBuzzImpl.getResult(59), "This Should return Buzz"));
	}
}
